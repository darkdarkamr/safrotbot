...
let fakecontact = { 'key': { 'participants': '0@s.whatsapp.net', 'remoteJid': 'status@broadcast', 'fromMe': false, 'id': '𝑭𝑶𝑿-𝑩𝑶𝑻' }, 'message': { 'contactMessage': { 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD` } }, 'participant': '0@s.whatsapp.net' };
let fakegif = {key: {participant: `0@s.whatsapp.net`, ...('6289643739077-1613049930@g.us' ? {remoteJid: '6289643739077-1613049930@g.us'} : {})}, message: {'videoMessage': {'title': '𝑭𝑶𝑿-𝑩𝑶𝑻', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': '𝑭𝑶𝑿-𝑩𝑶𝑻', 'jpegThumbnail': false}}};
...
let faketext = {
  ...
  message: {
    conversation: '•🌚💗فوكس بتاع المصنوره•'
  }
};
...
let poster = ['https://i.ibb.co/VDZSnxd/file.jpg', 'https://i.ibb.co/VDZSnxd/file.jpg', 'https://i.ibb.co/VDZSnxd/file.jpg']
...
await conn.sendContact(m.chat, [[`201289211701` + `@s.whatsapp.net`, wm]], vn, {
 contextInfo: { 
